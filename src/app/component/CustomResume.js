            ...
            <div className="resume-wrapper">
                ...
                <div className="resume-body">
                                        ...
                                        {familyList.length > 0 ? (
                                            familyList.map((family, index) => (
                                                <TableRow key={family.id}>
                                                    ...
                                                    <TableCell align="center" className="table-cell">
                                                        {moment(new Date(family?.dateOfBirth)).format("DD/MM/YYYY")}
                                                    </TableCell>
                                                    <TableCell align="center" className="table-cell">
                    ...
                    <div className="resume-reassurance">
                        ...
                        <p>Tôi xin cam đoan bản khai sơ yếu lý lịch trên là đúng sự thật, nếu có điều gì không đúng tôi xin chịu trách nhiệm trước pháp luật về lời khai của mình.</p>
                    </div>
                </div>
