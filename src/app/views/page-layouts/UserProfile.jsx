...
const API_PATH = ConstantList.API_ENDPOINT + "/api/fileUpload/";
...
class UserProfile extends Component {
  ...
  handleUpdate = (blobValue) => {
    let { t } = this.props;
    const url = ConstantList.API_ENDPOINT + "/api/users/updateavatar";
        ...
        <div className="user-profile__sidenav flex-column flex-middle">
          {this.state.user && this.state.user ? (
            <Avatar
              ...
              src={ConstantList.API_ENDPOINT + this.state.user.imagePath}
