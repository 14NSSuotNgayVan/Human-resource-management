...
const SalaryIncrement = (props) => {
  ...
  let columns = [
    ...
    { title: t("staff.salary_increment.reason"), field: "reason", align: "left", minWidth: "170px" },
    {
          ...
          <Grid item lg={3} md={3} sm={6} xs={6}>
            ...
            <Grid item xs={6} sm={6} md={3} lg={3}>
              <TextValidator
                ...
                errorMessages={[t("staff.notify.errorMessages_required"),`${t("staff.notify.invalidStringContent")}(250 kí tự)`]}
                variant="outlined"
                size="small"
              />
            </Grid>
